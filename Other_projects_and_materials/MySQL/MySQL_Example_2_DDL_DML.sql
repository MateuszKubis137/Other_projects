...
SELECT 
    imie, nazwisko, idzamowienia, data
FROM
    klienci k,
    zamowienia z
WHERE
    k.idklienta = z.idklienta;
...
SELECT 
    imie, nazwisko, tytul, imieautora, nazwiskoautora
FROM
    klienci k,
    zamowienia z,
    ksiazki ks
WHERE
    imie = 'Jan' AND nazwisko = 'Nowak'
        AND k.idklienta = z.idklienta
...
SELECT 
    imie, nazwisko, idzamowienia, data, status, tytul
FROM
    klienci k,
    zamowienia z,
    ksiazki ks
